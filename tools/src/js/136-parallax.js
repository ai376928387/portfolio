$(document).ready(function() {
    ...
    function mr_parallax() {
        ...
        jQuery(document).ready(function() {
            ...
            "use strict";
            return n = Math.max(document.documentElement.clientHeight, window.innerHeight || 0), /Android|iPad|iPhone|iPod|BlackBerry|Windows Phone/i.test(navigator.userAgent || navigator.vendor || window.opera) ? jQuery(".parallax_cameo").removeClass("parallax") : k && (E.profileParallaxElements(), E.setupParallax()), i(a) ? void a() : void 0
            ...
            j = [], o = b(), selector = ".parallax_cameo > .background-image-holder, .parallax_cameo ul.slides > li > .background-image-holder", C && (selector = ".viu .parallax_cameo > .background-image-holder, .viu .parallax_cameo ul.slides > li > .background-image-holder"), jQuery(selector).each(function(a, b) {
                var c = jQuery(this).closest(".parallax_cameo"),
